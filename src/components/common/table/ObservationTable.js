...
class ObservationTable extends React.Component {
    ...
    data: [
      createData(
        ...
        [
          ...
          { number: "7XPP", position: "L" }
        ],
        [{ number: "8RQP", color: "W", position: "Ri-so-Si" }]
      ),
      createData(
        new Date().toDateString(),
        "CC",
  ...
  renderMarks = marks => {
    ...
    for (let i = 0; i < marks.length; i++) {
      ...
      markComponents.push(
        <MarkChip key={i} number={number} position={position} />
      );
    }
  ...
  renderTags = tags => {
    ...
    for (let i = 0; i < tags.length; i++) {
      ...
      tagComponents.push(
        <TagChip key={i} number={number} position={position} color={color} />
      );
    }
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {this.renderMarks(n.marks)}
                        </TableCell>
                        <TableCell align="left">
                          {this.renderTags(n.tags)}
                        </TableCell>
                      </TableRow>
                    );
                  })}
